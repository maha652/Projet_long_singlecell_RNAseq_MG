...
##
## using: sbatch /mnt/beegfs/userdata/m_graa/pl_sc/script_projet_long/run_pipeline_analyse_indiv.sh
########################################################################
...
path_to_configfile="/mnt/beegfs/userdata/m_graa/pl_sc/script_projet_long/parametres_analyses_indiv.yaml"
