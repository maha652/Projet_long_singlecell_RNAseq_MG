...
##
## using: sbatch /mnt/beegfs/userdata/m_graa/pl_sc/script_projet_long/run_pipeline_analyse_grp.sh
########################################################################
...
path_to_configfile="/mnt/beegfs/userdata/m_graa/pl_sc/script_projet_long/parametres_analyses_groupees.yaml"
